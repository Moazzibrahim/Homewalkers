...
import 'package:homewalkers_app/presentation/widgets/marketer/filter_leads_dialog.dart';
      ...
      builder: (context, state) {
        if (widget.stageName != null) {
          ...
          WidgetsBinding.instance.addPostFrameCallback((_) {
            context.read<GetLeadsMarketerCubit>().filterLeadsByStageInMarketer(
              widget.stageName!,
            );
          });
        }
                    ...
                    children: [
                        ...
                        child: TextField(
                          ...
                          onChanged: (value) {
                            context
                                ...
                                .filterLeadsMarketer(query: value.trim());
                          },
                      ...
                      Container(
                        ...
                        child: IconButton(
                          ...
                          onPressed: () {
                            showFilterDialogMarketer(context);
                          },
                        ),
                      ),
                    ],
                                        ...
                                        Expanded(
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                "total submissions : ${lead.totalSubmissions}",
                                              ),
                                            ],
                                          ),
                                        ),
