      ...
      child: BlocListener<AddInMenuCubit, AddInMenuState>(
        listener: (context, state) {
          ...
          if (state is AddInMenuSuccess) {
            ...
            context.read<GetCancelReasonCubit>().fetchCancelReasons();
                ...
                Container(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      hintText: "Search cancel reasons...",
                      hintStyle: TextStyle(
                  ...
                  showDialog(
                    ...
                    builder:
                        (_) => BlocProvider.value(
                          ...
                          child: UpdateDialog(
                            initialValue: item.cancelReason,
                            title: "cancel reason",
                            onAdd: (value) {
      ...
      builder:
          (_) => BlocProvider.value(
            ...
            child: AddCancelReasonDialog(
              onAdd: (value) {
                context.read<AddInMenuCubit>().addCancelReason(value);
              },
              title: "cancel reason",
            ),
          ),
