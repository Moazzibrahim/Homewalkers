...
class RegionTrash extends StatefulWidget {
  const RegionTrash({super.key});

  @override
  State<RegionTrash> createState() => _RegionTrashState();
}

class _RegionTrashState extends State<RegionTrash> {
                ...
                Container(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      hintText: "Search deleted regions...",
                      hintStyle: TextStyle(
                  ...
                  child: BlocBuilder<GetCitiesCubit, GetCitiesState>(
                    builder: (context, state) {
                      if (state is GetCitiesLoading) {
                        ...
                        if (filtered.isEmpty) {
                          return const Center(
                            child: Text('No deleted regions found.'),
                          );
                        }
