...
class CitiesTrashScreen extends StatefulWidget {
  const CitiesTrashScreen({super.key});

  @override
  State<CitiesTrashScreen> createState() => _CitiesTrashScreenState();
}

class _CitiesTrashScreenState extends State<CitiesTrashScreen> {
                ...
                Container(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      hintText: "Search deleted cities...",
                      hintStyle: TextStyle(
                  ...
                  child: BlocBuilder<GetCitiesCubit, GetCitiesState>(
                    builder: (context, state) {
                      if (state is GetCitiesLoading) {
                        ...
                        if (filtered.isEmpty) {
                          return const Center(
                            child: Text('No deleted cities found.'),
                          );
                        }
