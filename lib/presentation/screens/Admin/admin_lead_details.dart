...
class _SalesLeadsDetailsScreenState extends State<AdminLeadDetails> {
  ...
  Widget _buildCopyButton(bool isDark, Color primaryColor) {
    ...
    if (totalSubmissions <= 1 || widget.ignoredublicates != true) {
  ...
  Widget _buildLastCommentSection(bool isDark, Color primaryColor) {
    return BlocBuilder<LeadCommentsCubit, LeadCommentsState>(
      builder: (context, state) {
        ...
        // ✅ بعد
        salesNameFromComment =
            widget.lastcommentSales ?? widget.leadSalesName ?? 'Unknown User';

        // جيب النص لو مش موجود من الـ widget
          ...
          child: Column(
            ...
            children: [
              ...
              _buildCommentBubble(
                ...
                isDark: isDark,
                salesNameFromComment: salesNameFromComment,
              ),
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            salesNameFromComment ?? 'Unknown User',
                            maxLines: 1,
                            overflow: TextOverflow.ellipsis,
                            style: TextStyle(
                              fontSize: 13.sp,
