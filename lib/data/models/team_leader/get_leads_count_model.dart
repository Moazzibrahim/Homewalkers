...
class TeamLeaderResponse {
  ...
  TeamLeaderResponse({this.success, this.teamLeader, this.totalSales, this.totalReviewerLeads, this.data});

  factory TeamLeaderResponse.fromJson(Map<String, dynamic> json) => TeamLeaderResponse(
        success: json['success'],
        teamLeader: json['teamLeader'] != null ? User.fromJson(json['teamLeader']) : null,
        totalSales: json['totalSales'],
        totalReviewerLeads: json['totalReviewerLeads'],
        data: json['data'] != null ? List<SalesData>.from(json['data'].map((x) => SalesData.fromJson(x))) : null,
      );
}
...
class SalesData {
  ...
  SalesData({this.salesID, this.salesName, this.totalLeads, this.isReviewer, this.stages});
  ...
  factory SalesData.fromJson(Map<String, dynamic> json) => SalesData(
        ...
        stages: json['stages'] != null ? List<Stage>.from(json['stages'].map((x) => Stage.fromJson(x))) : null,
      );
}
...
class Stage {
  ...
  factory Stage.fromJson(Map<String, dynamic> json) => Stage(
        ...
        count: json['count'],
        leads: json['leads'] != null ? List<Lead>.from(json['leads'].map((x) => Lead.fromJson(x))) : null,
      );
}
...
class Lead {
  ...
  factory Lead.fromJson(Map<String, dynamic> json) => Lead(
        ...
        allVersions: json['allVersions'] != null ? List<LeadVersion>.from(json['allVersions'].map((x) => LeadVersion.fromJson(x))) : null,
...
class Sales {
  ...
  factory Sales.fromJson(Map<String, dynamic> json) => Sales(
        id: json['_id'],
        name: json['name'],
        city: json['city'] != null ? List<City>.from(json['city'].map((x) => City.fromJson(x))) : null,
...
class Stagetype {
  ...
  factory Stagetype.fromJson(Map<String, dynamic> json) => Stagetype(
        id: json['_id'],
        name: json['name'],
      );
}
...
class Campaign {
  ...
  Campaign({this.id, this.name, this.date, this.cost, this.isactivate, this.addby, this.updatedby});
