class LeadAssignedModel {
  ...
  LeadAssignedModel({this.results, this.pagination, this.data});

  factory LeadAssignedModel.fromJson(Map<String, dynamic> json) =>
      LeadAssignedModel(
  ...
  factory AssignmentData.fromJson(Map<String, dynamic> json) => AssignmentData(
    ...
    assignedFrom:
        json['Assigned_From'] != null
            ? BasicInfo.fromJson(json['Assigned_From'])
            : null,
    assignedTo:
        json['Assigned_to'] != null
            ? SalesInfo.fromJson(json['Assigned_to'])
            : null,
...
class Project {
  ...
  factory Project.fromJson(Map<String, dynamic>? json) => Project(
    ...
    developer:
        json?['developer'] != null
            ? BasicInfo.fromJson(json!['developer'])
            : null,
...
class SalesInfo extends BasicInfo {
  ...
  factory SalesInfo.fromJson(Map<String, dynamic>? json) => SalesInfo(
    ...
    city:
        json?['city'] != null
            ? List<BasicInfo>.from(
              json!['city'].map((x) => BasicInfo.fromJson(x)),
            )
            : null,
    userlog:
...
class BasicInfo {
  ...
  factory BasicInfo.fromJson(Map<String, dynamic>? json) =>
      BasicInfo(id: json?['_id'], name: json?['name']);
}
...
class Stage {
  ...
  factory Stage.fromJson(Map<String, dynamic>? json) => Stage(
    ...
    stageType:
        json?['stagetype'] != null
            ? BasicInfo.fromJson(json!['stagetype'])
            : null,
  );
}
